...
class DemandsControllerTest < ActionController::TestCase
  ...
  test "should create demand" do
    assert_difference('Demand.count') do
      post :create, demand: { demand_type: @demand.demand_type, description: @demand.description, service_id: @demand.service_id, status: @demand.status, title: @demand.title, user_id: @demand.user_id }
    end
  ...
  test "should update demand" do
    patch :update, id: @demand, demand: { demand_type: @demand.demand_type, description: @demand.description, service_id: @demand.service_id, status: @demand.status, title: @demand.title, user_id: @demand.user_id }
    assert_redirected_to demand_path(assigns(:demand))
  end
